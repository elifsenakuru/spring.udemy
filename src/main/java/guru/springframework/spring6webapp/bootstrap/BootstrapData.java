...
public class BootstrapData implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        publisher1.setPublisherName("My Publisher1");
        publisher1.setCity("Ankara");
        publisher1.setAddress("Gokkusagi");
        publisher1.setZipCode("9876");
        publisher1.setState("Turkiye");
